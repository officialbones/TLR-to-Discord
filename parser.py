...
KEYWORD_INCIDENT_MAP = [
    # Entrapment / trapped — before crashes so "tipped over + can't exit" hits first
    ("entrapment", "Entrapment/Rescue"),
    ("not able to exit", "Entrapment/Rescue"),
    ("unable to exit", "Entrapment/Rescue"),
    ("can't exit", "Entrapment/Rescue"),
    ("trapped", "Entrapment/Rescue"),
    ("pin-in", "Entrapment/Rescue"),
    ("pinned in", "Entrapment/Rescue"),
    ("extrication", "Entrapment/Rescue"),
    # Crashes / accidents
    ("tipped over", "Vehicle Crash - Rollover"),
    ("overturned", "Vehicle Crash - Rollover"),
    ("rolled over", "Vehicle Crash - Rollover"),
